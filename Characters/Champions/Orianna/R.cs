...
namespace Spells
{
    public class OrianaDetonateCommand : ISpellScript
    {
        ...
        {
            IMinion _ball = AddMinion(owner, "OriannaBall", "OriannaBall" + owner.Team, end, owner.Team, owner.SkinID, true, false);
            AddParticlePos(owner, "oriana_ball_glow_green.troy", _ball.Position, _ball.Position, 5f, teamOnly: owner.Team, bone: "BUFFBONE_CSTM_WEAPONA");
